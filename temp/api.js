...
const API = {
  ...
  // crn is optional. When provided, the server picks the exact section
  // with that CRN — important for courses with multiple sections (e.g.
  // an online section and an in-person section sharing one course code).
  // Without crn the server falls back to the first matching course.
  addRecord: (courseCode, grade, semester, completed, crn) =>
    apiPost('/record', { courseCode, grade, semester,
